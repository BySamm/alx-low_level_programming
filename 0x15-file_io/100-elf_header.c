...
/**
 * check_elf - Checks if a file is an file.
...
/**
 * print_mag - Prints the magic numbers of an header.
 * @e_ident: A pointer to an array containing the ELF the number.
...
/**
 * print_type - Prints the type of an header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * print_entry - Prints the entry point of an header.
 ...
 * ELF header at the start of an file.
